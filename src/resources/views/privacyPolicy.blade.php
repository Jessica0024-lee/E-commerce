...
<div class="container mt-5">
    ...
    <ul>
        ...
        <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                or
                &quot;Our&quot; in this Agreement) refers to Fashion Ecommerce.</p>
        </li>
        <li>
        ...
        <li>
            <p><strong>Website</strong> refers to Fashion Ecommerce, accessible from <a href="http://www.happypet.com"
                    rel="external nofollow noopener" target="_blank">http://www.happyfashion.com</a></p>
        </li>
        <li>
    ...
    <ul>
        <li>By email: fashion@gmail.com</li>
    </ul>
</div>
@endsection