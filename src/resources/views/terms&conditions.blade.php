...
<div class="container mt-5">
    ...
    <p>Welcome to Fashion Ecommerce!</p>

    <p>These terms and conditions outline the rules and regulations for the use of Fashion Ecommerce's Website, located at
        http://www,happypet.com.</p>

    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Fashion Ecommerce if
        you do
    ...
    <p>We employ the use of cookies. By accessing Fashion Ecommerce, you agreed to use cookies in agreement with the Fashion Ecommerce's
        Privacy Policy. </p>
    ...
    <p>Unless otherwise stated, Fashion Ecommerce and/or its licensors own the intellectual property rights for all material on
        Fashion Ecommerce. All intellectual property rights are reserved. You may access this from Fashion Ecommerce for your own
        personal
        use subjected to restrictions set in these terms and conditions.</p>

    <p>You must not:</p>
    <ul>
        <li>Republish material from Fashion Ecommerce</li>
        <li>Sell, rent or sub-license material from Fashion Ecommerce</li>
        <li>Reproduce, duplicate or copy material from Fashion Ecommerce</li>
        <li>Redistribute content from Fashion Ecommerce</li>
    </ul>
    ...
    <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
        areas
        of the website. Fashion Ecommerce does not filter, edit, publish or review Comments prior to their presence on the
        website.
        Comments do not reflect the views and opinions of Fashion Ecommerce,its agents and/or affiliates. Comments reflect the
        views
        and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, Happy
        Pet
    ...
    <p>Fashion Ecommerce reserves the right to monitor all Comments and to remove any Comments which can be considered
    ...
    <p>You hereby grant Fashion Ecommerce a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce
        and
    ...
    <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
        ...
        records
        with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Fashion Ecommerce; and
        (d)
    ...
    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you
        must inform us by sending an e-mail to Fashion Ecommerce. Please include your name, your organization name, contact
    ...
    <p>No use of Fashion Ecommerce's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
